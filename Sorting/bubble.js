...
async function BubbleSort() {
    ...
    for (let i = 0; i < element.length - 1; i++) {//loop for all elements
        ...
        for (let j = 0; j < element.length - i - 1; j++) {//loop for all the elements except sorted elements
            ...
            //j----------------------------
            element[j + 1].style.background = 'rgb(1, 0, 88)';
            //j+1--------------------------
            ...
            element[j].style.background = 'rgb(0, 0, 0)';
            element[j + 1].style.background = 'rgb(210, 230, 216)';
    ...
    element[0].style.background = 'rgb(228, 218, 231)';
    //ist index-----------------------------
    done.play()
